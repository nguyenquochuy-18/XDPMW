            ...
            <div className="row">
              <div className="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div className="categories_post">
                  <img className="card-img rounded-0" src="img/blog/cat-post/cat-post-3.jpg" alt="post" />
              ...
              <div className="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div className="categories_post">
                  <img className="card-img rounded-0" src="img/blog/cat-post/cat-post-2.jpg" alt="post" />
                  <div className="categories_details">
                    <div className="categories_text">
                      <a href="single-blog.html">
                        <h5>Politics</h5>
              ...
              <div className="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div className="categories_post">
                  <img className="card-img rounded-0" src="img/blog/cat-post/cat-post-1.jpg" alt="post" />
                  <div className="categories_details">
                    <div className="categories_text">
                      <a href="single-blog.html">
                        <h5>Food</h5>
                    ...
                    <div className="col-md-9">
                      <div className="blog_post">
                        ...
                        <div className="blog_details">
                          ...
                          <a className="button button-blog" href="single-blog.html">View More</a>
                        </div>
                      </div>
                    </div>
                  </article>
                      ...
                      <div className="blog_post">
                        ...
                        <div className="blog_details">
                          ...
                          <p>MCSE boot camps have its supporters and its detractors. Some people do not understand
                            why you should have to spend money on boot camp when you can get the MCSE study
                            materials yourself at a fraction.</p>
                          <a href="single-blog.html" className="button button-blog">View More</a>
                        </div>
                      </div>
                    </div>
                  </article>
                  ...
                  <aside className="single-sidebar-widget newsletter_widget">
                    ...
                    <div className="form-group d-flex flex-row">
                      <div className="input-group">
                        ...
                        <input type="text" className="form-control" id="inlineFormInputGroup" placeholder="Enter email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email'" />
                      </div>
